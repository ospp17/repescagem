...
SELECT*from Medico
WHERE 'data de contrato' < '2020';

SELECT * order by Medico asc;

SELECT * FROM Medico
ORDER BY email, 'cirurgia';

SELECT * FROM Medico
ORDER BY nome,'nome' desc;

SELECT * FROM Medico
where horario_trabalho = '12:00' and '20:00' ;
...
SELECT * FROM Medico
where salario = '1500' and '1600' ;

SELECT * FROM Medico
where salario = 'salario' / 'quantidade' ;
